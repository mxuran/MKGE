...
""""""
# train the model
trainer = Trainer(model = model, data_loader = train_dataloader, train_times = 500, alpha = 0.1, use_gpu = True, opt_method = "adagrad", checkpoint_dir = "./checkpoint_DeepDDI", save_steps = 1000)
trainer.run()
if add_mol:
